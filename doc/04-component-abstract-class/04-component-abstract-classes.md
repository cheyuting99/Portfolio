...
Added a kernal method public boolean isValidDimensions(double width, double height) to check if the dimension is valid( both height and length are greter than 0).
