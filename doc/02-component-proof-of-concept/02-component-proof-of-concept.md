...
> disclose that here as well.
 ...
 I have chosen the Rectangle component design because it provides a clear and straightforward model for representing rectangles in a 2D space. The design includes essential kernel methods for accessing and setting the dimensions of the rectangle, along with secondary methods for performing common geometric calculations such as area, perimeter, and resizing. This design strikes a balance between simplicity and functionality, making it a suitable choice to start with. As we progress, we can refine and iterate upon this design as needed.
